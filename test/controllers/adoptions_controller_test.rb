...
class AdoptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adoption" do
    assert_difference("Adoption.count") do
      post adoptions_url, params: { adoption: { age: @adoption.age, breed: @adoption.breed, details: @adoption.details, name: @adoption.name } }
    end
  ...
  test "should update adoption" do
    patch adoption_url(@adoption), params: { adoption: { age: @adoption.age, breed: @adoption.breed, details: @adoption.details, name: @adoption.name } }
